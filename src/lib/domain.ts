...
export type EventItem = Base & { starts_at: string; ends_at: string; location: string; description: string; provider?: 'google' | 'microsoft'; external_id?: string; web_url?: string | null; meeting_url?: string | null; organizer?: string; is_all_day?: boolean };
